...
class LoginViewModelTest {
    ...
    @Test
    fun getLogInState() {
        val initialLoginState = loginViewModel.formDataFlow.value
        ...
        val updatedLoginState = loginViewModel.formDataFlow.value
