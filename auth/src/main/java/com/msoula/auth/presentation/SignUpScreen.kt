            ...
            Box(
                ...
                Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                    ...
                    HMMTextFieldAuthComponent(
                        ...
                        onValueChange = {
                            signUpViewModel.onEvent(AuthUIEvent.OnFirstNameChanged(it))
                        },
                    ...
                    HMMTextFieldAuthComponent(
                        ...
                        onValueChange = {
                            signUpViewModel.onEvent(AuthUIEvent.OnLastNameChanged(it))
                        },
                    ...
                    HMMTextFieldAuthComponent(
                        ...
                        onValueChange = {
                            signUpViewModel.onEvent(AuthUIEvent.OnEmailChanged(it))
                        },
                    ...
                    HMMTextFieldPasswordComponent(
                        ...
                        onValueChange = {
                            signUpViewModel.onEvent(AuthUIEvent.OnPasswordChanged(it))
                        },
