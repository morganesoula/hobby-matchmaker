...
object Modules {
    ...
    const val HUB_DOMAIN = ":features:hub:domain"
    const val HUB_PRESENTATION = ":features:hub:presentation"
    ...
    const val PROFILE_DATA = ":features:profile:data"
    const val PROFILE_DOMAIN = ":features:profile:domain"
